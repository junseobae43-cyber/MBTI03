...
(function() {
    ...
    function loop() {
        if (gameState === "SELECT") {
            ...
            ctx.fillStyle = "cyan"; ctx.fillRect(570, 20, (p2.hp / p2.maxHp) * 300, 20);
            ctx.fillStyle = "yellow"; ctx.fillRect(570, 45, (p2.ultGauge / 100) * 300, 8);
            ...
            const winTxt = p1.hp > 0 ? "1P WIN!" : "2P WIN!";
...
# 3. Streamlit 화면 출력
components.html(GAME_ENGINE, height=520)
