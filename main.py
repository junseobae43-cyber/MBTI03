...
<body>
    <div class="notice">⚡ GOD 배준서 스펙 초월 가동 (HP 2000 / ATK 150) ⚡</div>
    <div class="info">
...
function runGame() {
    ...
    var CHARACTERS = [
        ...
        { name: "마샬 로우", color: "#DB2777", beltColor: "#000000", hairColor: "#18181B", skinColor: "#EAB308", eyeColor: "#000000", hp: 180, speed: 9, atk: 18, ult: 70 },
        { name: "킹", color: "#0891B2", beltColor: "#FFFFFF", hairColor: "#D97706", skinColor: "#B45309", eyeColor: "#000000", hp: 220, speed: 7, atk: 24, ult: 85 },
        { name: "니나 윌리엄스", color: "#E11D48", beltColor: "#FFFFFF", hairColor: "#FEF08A", skinColor: "#FFF0F5", eyeColor: "#2563EB", hp: 185, speed: 9, atk: 19, ult: 72 },
        { name: "화랑", color: "#EA580C", beltColor: "#000000", hairColor: "#F97316", skinColor: "#FFE4E6", eyeColor: "#1E293B", hp: 180, speed: 10, atk: 17, ult: 68 },
        { name: "요시미츠", color: "#0D9488", beltColor: "#FFD700", hairColor: "#64748B", skinColor: "#0284C7", eyeColor: "#FACC15", hp: 210, speed: 7, atk: 21, ult: 82 },
        { name: "브라이언 퓨리", color: "#475569", beltColor: "#000000", hairColor: "#94A3B8", skinColor: "#E2E8F0", eyeColor: "#DC2626", hp: 225, speed: 6, atk: 26, ult: 90 }
    ];
    ...
    function updatePlayer(p, enemy, lKey, rKey, jKey, gKey, aKey, uKey, tKey) {
    ...
    function drawSelectScreen() {
        ...
        ctx.fillText("TEKKEN SELECT YOUR FIGHTER", 280, 35);
    ...
    function loop() {
        if (gameState === "SELECT") {
            ...
            updatePlayer(p1, p2, 'a', 'd', 'w', 's', 'f', 'g', 't');
            updatePlayer(p2, p1, 'arrowleft', 'arrowright', 'arrowup', 'arrowdown', 'k', 'l', 'p');
...
components.html(GAME_ENGINE, height=660)
